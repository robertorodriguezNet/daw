...
class ClasesOperacionesService extends \SoapClient
{
  ...
  public function getPVP($idProducto)
  {
    ...
    return $operaciones->getPVP($idProducto);
  }
  ...
  {
    $operaciones = new Operaciones();
    return $operaciones->getStock($idProducto, $idTienda);
  }
  ...
  {
    $operaciones = new Operaciones();
    return $operaciones->getFamilias();
  }
  ...
  {
    $operaciones = new Operaciones();
    return $operaciones->getProductoFamilia($codFamilia);
  }
}
