...
class ClasesOperacionesService extends \SoapClient
{
  ...
  public function __construct(array $options = array(), $wsdl = null)
  {
    ...
    // Usamos la clase Operaciones ya creada.
  ...
  {
    return $this->operaciones->getPVP($idProducto);
  }
  ...
  {
    $this->operaciones->getStock($idProducto, $idTienda);
  }
  ...
  {
    return $this->operaciones->getFamilias();
  }
  ...
  {
    return $this->operaciones->getProductoFamilia($codFamilia);
  }
}
