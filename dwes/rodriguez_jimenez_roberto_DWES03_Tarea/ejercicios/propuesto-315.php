...
<body style="background: antiquewhite">
    ...
    <div class="container mt-3">
        ...
        if (isset($_POST['enviar'])) {
            //hemos enviado el formulario para consultar las unidades
            ...
            $stmt1->bind_result($n, $nc);
            //$n=nombre, $nc=nombre_corto
            $stmt1->fetch();
            //esta consulta solo devuelve una fila, no es necesario el while
            $stmt1->close();
            if (!$stmt->execute()) {
            ...
            //Hemos enviado el formulario para modificar las unidades
            $codTienda = $_POST['ct'];
            ...
            //no hemos enviado ningún formulario
            ?>
